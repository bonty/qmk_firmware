...
[_QWERTY]=LAYOUT(   // QWERTY
			ALTTAB	,	KC_Q	,	KC_W	,	KC_E	,	KC_R	,	KC_T	,							KC_Y	,	KC_U	,	KC_I	,	KC_O	,	KC_P	,	KC_BSPC	,	ONEPASS	,
			CTLESC	,	KC_A	,	KC_S	,	KC_D	,	KC_F	,	KC_G	,							KC_H	,	KC_J	,	KC_K	,	KC_L	,	KC_SCLN	,	KC_MINS	,	ALFRED	,
			OS_SFT	,	KC_Z	,	KC_X	,	KC_C	,	KC_V	,	KC_B	,	KC_DEL	,	KC_LGUI	,	KC_N	,	KC_M	,	KC_COMM	,	KC_DOT	,	KC_SLSH	,	KC_RALT	,
	XXXXXXX	,						KC_LGUI	,	NUMBER	,	MT_SPC	,	SFTSPC	,	    MO(_NUMBER)	,   	CTLTAB	,	SFTENT	,	SYMBOL	,	KC_RGUI	,
...
[_NAV]=LAYOUT(   // Navigation
			OPTION	,	XXXXXXX	,	XXXXXXX	,	ONEPASS	,	ALFRED	,	XXXXXXX	,							KC_HOME	,	KC_PGDN	,	KC_PGUP	,	KC_END	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,
			XXXXXXX	,	OS_CTL	,	OS_ALT	,	OS_GUI	,	OS_SFT	,	XXXXXXX	,							KC_LEFT	,	KC_DOWN	,	KC_UP	,	KC_RGHT	,	HISTBK	,	XXXXXXX	,	XXXXXXX	,
			REDO	,	UNDO	,	CUT		,	COPY	,	PASTE	,	XXXXXXX	,	XXXXXXX	,			XXXXXXX	,	XXXXXXX	,	PREVTAB	,	NEXTTAB	,	XXXXXXX	,	HISTFW	,	XXXXXXX	,
...
[_NUMBER]=LAYOUT(   // Number
			...
			XXXXXXX	,	KC_1	,	KC_2	,	KC_3	,	KC_4	,	KC_5	,							KC_6	,	KC_7	,	KC_8	,	KC_9	,	KC_0	,	KC_F12	,	XXXXXXX	,
			XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	KC_LANG2,	XXXXXXX	,	XXXXXXX	,			XXXXXXX	,	XXXXXXX	,	KC_LANG1,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,
	XXXXXXX	,							XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,	XXXXXXX	,
			XXXXXXX	,	XXXXXXX	,							XXXXXXX	,	XXXXXXX	,			XXXXXXX	,	XXXXXXX
),
