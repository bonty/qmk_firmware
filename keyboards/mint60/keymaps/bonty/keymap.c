...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LCTL,      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,   MO(3), \
    KC_ESC, KC_LCTL, KC_LALT, GUI_T(KC_LANG2), SFT_T(KC_SPC), LT(2,KC_ENT), GUI_T(KC_LANG1), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT \
  ),
  [1] = LAYOUT( \
    KC_NO,       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, \
    KC_NO,     G(KC_Q), G(KC_BSPC), A(KC_BSPC), A(KC_DEL), KC_NO, G(KC_LEFT), KC_PGDN, KC_PGUP, G(KC_RGHT), C(S(KC_TAB)), KC_NO, KC_NO, KC_NO, \
    KC_TRNS, G(KC_A), KC_LSFT, KC_BSPC, KC_DEL, C(KC_K), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, C(KC_SCLN), KC_NO, C(KC_ENT), \
    KC_TRNS, G(KC_Z), G(KC_X), G(KC_C), G(KC_V), KC_NO, C(KC_TAB), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO \
  ),
  [2] = LAYOUT( \
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_NO, \
